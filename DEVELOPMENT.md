...
| `holidays` | 休日マスタ |
| `settings` | 設定KV |
| `member_monthly_costs` | メンバー月次コスト（給与） |
| `team_monthly_pl` | チーム月次損益サマリ |
...
### データソース
- **PLスプレッドシートID**: `1kOAmuUSpY_2rV2EpIbhRtBsoxeehGuz9GYLTFn0xpdQ`
- シート構成: Teamコスト / 粗利シート / 全体損益確認

### member_monthly_costs テーブル
メンバー別の月次給与コスト。PLシート「Teamコスト」のデータをDB化。

| メンバー | 2月 | 3月 | 4月 | 5月 | 6月 |
|----------|-----|-----|-----|-----|-----|
| 菊池 | 75万 | 75万 | 75万 | 75万 | 75万 |
| 野口 | 62.5万 | 62.5万 | 62.5万 | 62.5万 | 62.5万 |
| JB | 40万 | 40万 | 40万 | 40万 | 40万 |
| 松居 | 35万 | 35万 | 35万 | 37万 | 37万 |
| 中村 峻也 | 35万 | 35万 | 35万 | 35万 | 35万 |
| 坪井 | 30万 | 30万 | 30万 | 30万 | 32万 |
| 山本 | 30万 | 30万 | 30万 | 30万 | 30万 |
| 美除 | - | 20万 | 30万 | 30万 | 30万 |
| 辻森 | - | 20万 | 30万 | 30万 | 30万 |
| 田中颯汰 | - | 20万 | 30万 | 30万 | 30万 |
| 田中克樹 | 10万 | 10万 | - | - | - |
| 村松 | 15万 | 15万 | 15万 | 15万 | 15万 |
| 山内（事務） | 27万 | 27万 | 27万 | 27万 | 27万 |
| 村上 | - | - | 30万 | 30万 | 30万 |
| TDB×2 | - | - | - | 20万×2 | 30万×2 |

### team_monthly_pl テーブル
チーム全体の月次損益サマリ。

| 月 | 売上 | コスト合計 | 粗利 |
|----|------|----------|------|
| 2月 | ¥5,881,000 | ¥3,595,000 | ¥2,286,000 |
| 3月 | ¥9,000,000 | ¥4,195,000 | ¥4,805,000 |
| 4月 | ¥9,000,000 | ¥4,695,000 | ¥4,305,000 |
| 5月 | ¥10,000,000 | ¥5,115,000 | ¥4,885,000 |
| 6月 | ¥10,500,000 | ¥5,335,000 | ¥5,165,000 |
...
粗利率 = 粗利 / 売上 × 100
```
- 売上は`appointments`テーブルの実施確定金額から算出
- コストは`member_monthly_costs`テーブルから月次集計
- ダッシュボードの概要タブで粗利・粗利率を表示可能

### 全体損益確認（参考）
会社全体のPL。菊池チーム（チーム900）は全社5チームのうちの1つ。
- 3月全社売上: ¥41,500,000（うち菊池: ¥8,500,000）
- 営業代行コスト: 全社で約¥12M/月
